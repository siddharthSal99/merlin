v4l2-ctl -d /dev/video1 --set-ctrl=brightness=20
v4l2-ctl -d /dev/video1 --set-ctrl=contrast=25
v4l2-ctl -d /dev/video1 --set-ctrl=saturation=57
v4l2-ctl -d /dev/video1 --set-ctrl=hue=1495
...
v4l2-ctl -d /dev/video1 --set-ctrl=white_balance_temperature=3227
